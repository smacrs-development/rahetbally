        ...
        var $el = {
            ...
            controls:               $('<div/>').addClass('control-bar'),
                buttons:            $('<div/>').addClass('button-bar'),
                    play:           $('<i/>').addClass('play').html("<i class='fas fa-play'></i>"),
                    pause:          $('<i/>').addClass('pause hidden').html("<i class='fas fa-pause'></i>"),
                    replay:         $('<i/>').addClass('replay hidden').html("<i class='fas fa-reply'></i>"),
                    ...
                    time:           $('<span/>').addClass('time'),
                        ...
                        fullscreen: $('<i/>').addClass('fullscreen').html("<i class='fas fa-compress'></i>"),
         ...
         // largePlay:                $('<span/>').addClass('large-play').html("&#61515;"),
          largePlay:                $('<span/>').addClass('large-play').html("<i class='fas fa-play'></i>"),
